...
# НАСТРОЙКИ ЛИМИТОВ
# ============================================
PARSE_LIMIT = 7000   # Сколько постов парсить за один запуск (для скорости)
CACHE_LIMIT = 7000   # Сколько постов хранить в кеше (история)
# ============================================
...
def update_cache(new_posts):
    ...
    # Обрезаем до CACHE_LIMIT (а не PARSE_LIMIT!)
